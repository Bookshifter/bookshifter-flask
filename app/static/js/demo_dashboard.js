$(function(){        
    ...
    Morris.Donut({
        ...
        data: [
            {label: "Encerrados", value: 15},
            {label: "Abertos", value: 2},
            {label: "Avaliados", value: 3}
        ],
        colors: ['#33414E', '#00D3C3', '#4AA400'],
        resize: true
    });
    ...
    Morris.Bar({
        ...
        xkey: 'y',
        ykeys: ['a', 'b'],
        labels: ['Operando', 'Fora do ar'],
        barColors: ['#4AA400', '#FF0000'],
        gridTextSize: '10px',
        hideHover: true,
        resize: true,
